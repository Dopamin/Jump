...
import com.slodopamin.jump.net.SubmitScore;
...
public class Game {
	...
	/* TODO: fix this worst system that the world has ever seen.
	...
	*/
	...
	private void submitScore() {
		...
		SubmitScore run = new SubmitScore();
		SubmitScore.score = score;
		SubmitScore.name = "Nexus";
		Thread send = new Thread(run);
		send.start();
	}
